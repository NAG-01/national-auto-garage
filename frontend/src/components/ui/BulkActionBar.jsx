...
export const BulkActionBar = ({
  ...
  return (
    <div className="bg-slate-900 text-white p-3 sm:px-4 sm:py-3.5 rounded-2xl shadow-xl border border-slate-800 flex flex-wrap items-center justify-between gap-3 animate-in fade-in slide-in-from-top-2 duration-200">
      ...
      <div className="flex items-center gap-2 shrink-0">
        <button
          ...
          onClick={onClear}
          disabled={deleting}
          className="bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 text-xs font-bold px-3 py-1.5 rounded-xl transition-all inline-flex items-center gap-1 shadow-2xs disabled:opacity-50"
        >
