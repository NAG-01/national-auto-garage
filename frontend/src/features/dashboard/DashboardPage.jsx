  ...
  return (
    <div className="space-y-5 max-w-3xl mx-auto py-2">
      ...
      {loading ? (
        ...
        /* SIMPLE & ELEGANT LOW STOCK ALERT CARD */
        <div className="bg-gradient-to-br from-amber-50/90 via-orange-50/40 to-amber-100/30 border-2 border-amber-300 rounded-2xl p-5 sm:p-6 shadow-sm space-y-4">
          ...
          <div className="space-y-3">
            {lowStockParts.map((p) => (
              <div
                ...
                className="p-4 bg-white rounded-xl border border-amber-200 border-l-4 border-l-amber-500 shadow-2xs flex flex-col sm:flex-row sm:items-center justify-between gap-3"
              >
                <div>
        ...
        <div className="bg-emerald-50/70 border border-emerald-200 rounded-2xl p-6 text-center space-y-3 shadow-2xs">
          <div className="w-11 h-11 rounded-xl bg-emerald-500 text-white flex items-center justify-center mx-auto shadow-xs">
